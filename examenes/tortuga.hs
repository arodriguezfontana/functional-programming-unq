...
-- Dado un programa de gráficos de tortuga, describe uno equivalente que no tiene argumentos a la izquierda de un (:#:) que estén formados por (:#:). SUGERENCIA: Considerar definir una función auxiliar para el caso inductivo.
